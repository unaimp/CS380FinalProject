...
// Direct3D 10
bool                     WINAPI DXUTIsD3D10Available(); // If D3D10 APIs are available
...
RECT      WINAPI DXUTGetFullscreenClientRectAtModeChange(); // Useful for returning to full screen mode with the same resolution as before toggle to windowed mode
