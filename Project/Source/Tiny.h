...
// File: Tiny.h
//
// Desc: Header file for the CTiny class.  Its declaration is found here.
//
...
protected:
	...
	bool                 m_bUserControl;      // true == user is controlling character with the keyboard
	...
	ID3DXAnimationCallbackHandler *
						 m_pCallbackHandler;  // pointer to callback interface to handle callback keys
