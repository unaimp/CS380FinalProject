...
void CDXUTDialog::SetCallback( PCALLBACKDXUTGUIEVENT pCallback, void* pUserContext )
{
    ...
    // was made so that the DXUT's GUI could become separate and optional from DXUT's core.  The 
...
VOID CDXUTDialog::SendEvent( UINT nEvent, bool bTriggeredByUser, CDXUTControl* pControl )
{
    ...
    // Discard events triggered programmatically if these types of events haven't been
    // enabled
